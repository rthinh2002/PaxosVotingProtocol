...
public class Election {
    public static void main(String[] args) throws IOException {
        ...
        if (args.length > 1 || args.length < 1) {
            ...
            // Validating error for proposers
            if (proposers > 3) {
                System.out.println(
                        "Invalid number of proposers, for this scenario, a maximum of 3 proposers will be accepted");
                return;
            }
        ...
        startElection(proposers, responseTime, offline);
    }

    // This method will receive number of proposers, response_time, and offline
    public static void startElection(int proposerNumber, String responseTime, int offline) {
        System.out.println("====== Election is Beginning ======");
        System.out.println("====== There are " + proposerNumber + " proposers and 6 acceptors ======");
